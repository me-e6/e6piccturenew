                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => DayAlbumViewerScreen(
                      posts: [widget.post], // 👈 SINGLE POST ONLY
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            /// RIGHT — ACTION CLUSTER (LOCKED WIDTH)
            Row(
              ...
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => [
                    if (!isOwner)
                      PopupMenuItem(
                        value: context.read<FollowController>().isFollowing
                            ? 'unfollow'
                            : 'follow',
                        child: Text(
                          context.read<FollowController>().isFollowing
                              ? 'Unfollow'
                              : 'Follow',
                        ),
                      ),
    ...
    return InkResponse(
      ...
      child: Padding(
        ...
        child: Icon(
          ...
          color:
              color ??
              Theme.of(context).iconTheme.color?.withValues(alpha: 0.85),
        ),
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            if (!isOwner)
              Consumer<FollowController>(
                builder: (_, f, __) => OutlinedButton(
                  onPressed: f.isFollowing
                      ? () => f.unfollow(post.authorId)
                      : () => f.follow(post.authorId),
                  style: OutlinedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(
                      horizontal: 10,
                      vertical: 4,
